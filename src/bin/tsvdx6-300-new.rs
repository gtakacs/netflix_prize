...
fn main() {
    let cfg = TxConfig {
        ...
        // Same-day neighborhood (active for tsvdx6 — distinguishes it from tsvdx5)
        lr_w_day: 0.001, lr_c_day: 0.001, reg_w_day: 0.002, reg_c_day: 0.002,
        // Sub-model lr multipliers
    ...
    fit2!(
        TxModel, cfg, "rtg", "tsvdx6-300", SPLIT_NEW,
        save_train: true,
